...
export function Sidebar({...props}) {
    ...
    return (
        <div className="h-screen bg-gray-800 text-white w-[200px] space-y-6 py-7 px-2">
            <div className="text-2xl font-semibold text-center">
                MyApp
            </div>
            <nav className="mt-10">
                <Link legacyBehavior href="/board/users">
                    <a className={`block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 ${router.pathname === '/board/users' ? 'bg-gray-700' : ''}`}>
                        Users
                    </a>
                </Link>
